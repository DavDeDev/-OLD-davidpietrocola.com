...
const projects = [
  {
    ...
    type: 'Discord Bot',
    description:
      'The project is built with Typescript and Discord.JS, and uses Google Calendar API to create, edit, and delete events, and it can also be used to send reminders to users about upcoming events. The bot was deployed to EC2, and it was integrated with a CI/CD pipeline using Github Actions and PM2 tasks.',
    tags: [
      {
        name: 'typescript',
  ...
  },
  {
    ...
    image: mintBuddy,
    source_code_link: 'https://github.com/WilliamUW/MintBuddy',
    live_demo_link:
    'https://d3oyycx6rea45m.cloudfront.net/',
  },
  {
    name: 'Opzione Zen',
